...
=======
=======
>>>>>>> 7ba676ff7dc1cdb68846d0715ddb0f67d275b02e
## 1.2 Data Description
All variable descriptions are from the UCI machine learning repository from this datset(Bank Marketing Dataset)[2]
1 - age (numeric)
...
*[1] Lopez, R. (2020). Customer segmentation using machine learning. Retrieved December 12, 2020, from https://www.neuraldesigner.com/blog/customer_segmentation_using_advanced_analytics*
*[2]Bank Marketing Data Set, [Moro Et Al., 2014] S. Moro, P. Cortez and P. Rita. A Data-Driven Approach to Predict the Success of Bank Telemarketing. Decision Support Systems, Elsevier, 62:22-31, June 2014, archive.ics.uci.edu/ml/datasets/Bank+Marketing.*
<<<<<<< HEAD
>>>>>>> 7ba676ff7dc1cdb68846d0715ddb0f67d275b02e
=======
>>>>>>> 7ba676ff7dc1cdb68846d0715ddb0f67d275b02e
...
8.) Contact
For those contacted by telephone the percentage of those who deposited were 13.4% while those contacted through cellphone were slightly more likely to have deposited with a percentage of 14.9%
...
#Tuning parameters
pred.tune.log = prediction(pred, bank.test$y)
...
auc.log
acc.log = (performance(pred.tune.log, measure = "acc")@y.values)
...
pred.cutoff = cut(logistic.pred, c(-Inf, 0.5, Inf), labels = c("No","Yes"))
