...
Reasons for selecting these predictive techniques:
...
Here is a summary of the logistic regression model with all 16 of the input variables (more interpretation of the output below). However, we would like to start with variable selection first to prune down this model. 
```{r, echo=FALSE}
#make copy of data
...
## Final Comparison between Logistic Regression and Random Forest
