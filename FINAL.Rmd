...
log.acc = (conf[1,1]+conf[2,2])/(sum(conf)); log.acc
```
...
#Classification accuracy
classicitation_accuracy_rf <- (conf_rf[1,1]+conf_rf[2,2])/(sum(conf_rf)); classicitation_accuracy_rf
```
