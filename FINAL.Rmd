...
bank.num %>%
  ...
  corrplot(method = "number",
           ...
           number.cex = 0.5)
```
The above correlogram is ordered in a first principle component manner. We can see that variables pday and 
...
comparison.table$Accuracy = c(log.acc, classicitation_accuracy_rf)
comparison.table$AUC = c(auc.log, AUC)
