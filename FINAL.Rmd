...
#View(bank_full)
bank_test <- read_delim("Desktop/STA 141A Final /bank.csv", 
    ";", escape_double = FALSE, trim_ws = TRUE)
View(bank_test)
bank.data = bank_full
head(bank.data)
...
#Stop. All p vaues significant at alpha = 0.05. Drawback = cutoff level is trivial choice. 
```
...
f_second_run <- add1(glm(as.factor(y)~as.factor(duration), binomial, data = na.omit(lr.bank.data)),
