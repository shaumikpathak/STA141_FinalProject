...
Particularly, we would first investigate the importance of variables and choose sqrt(p) as our a rule of thumb for amount of predictors. We used a manual tuning method to find the optimal ntree value for our random forest model which ended up being 300. This value of the entry had the highest accuracy rate at a value of approximately 0.904
...
model.list = list()
for (ntree in c(100,200,300,500)){
  set.seed(123)
