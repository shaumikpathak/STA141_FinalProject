...
Here is a summary of a logistic regression model with all 16 of the input variables: 
```{r, echo=FALSE}
#make copy of data
...
Furthermore, the corresponding confusion matrix is and the corresponding classification accuracy is `r classicitation_accuracy_rf`, very close to what we get in our logistic model after AIC variable selection. 
```{r}
conf_rf
```
